jQuery.validator.addMethod("charFilter", function (value, element) {
...
jQuery.validator.addMethod("tel", function (value, element) {
    var length = value.length;
    var tel = /^(1[3578][0-9]{9)|((0[0-9]{2,3}\-)?[2-9][0-9]{6,7})$/;
    return this.optional(element) || (tel.test(value));
}, "联系方式错误");
...
jQuery.validator.addMethod("isDate6", function (value, element) {
    return this.optional(element) || isDate6(value);
}, "请正确时间");
...
jQuery.validator.addMethod("reProvince", function (value, element) {
    return this.optional(element) || value != "省份";
}, "请选择省份");
jQuery.validator.addMethod("reCity", function (value, element) {
    return this.optional(element) || value != "地级市";
}, "请选择市");
jQuery.validator.addMethod("reCounty", function (value, element) {
