...
var AesSecret = (function () {
    function AesSecret() {
    }
    AesSecret.EncryptByAES = function (str) {
    ...
    AesSecret.DecryptByAES = function (str) {
        var key = CryptoJS.enc.Utf8.parse(this._KEY);
        var iv = CryptoJS.enc.Utf8.parse(this._IV);
    ...
    AesSecret._KEY = "^joZ1WnchwRbb^ecOjX!OajD9*XhOFQ6";
    AesSecret._IV = "C3JW$OEQ3AKlGAh5";
    return AesSecret;
}());
var TokenBuild = (function () {
    function TokenBuild() {
    }
    TokenBuild.CreateToken = function (jsonObj) {
        var keys = [];
        for (c in jsonObj) {
        ...
        return md5(md5(querystring) + this._KEY);
    };
    TokenBuild._KEY = "F5r@b1gG^7$ugK!W8R5DCb4wuLyc25n0";
    return TokenBuild;
}());
